	...
	<body>
		...
		<div id="show-bankAccount" class="content scaffold-show" role="main">
			...
			<ol class="property-list bankAccount">
				...
				<g:if test="${bankAccountInstance?.amount}">
				<li class="fieldcontain">
					<span id="amount-label" class="property-label"><g:message code="bankAccount.amount.label" default="Amount" /></span>
					
						<span class="property-value" aria-labelledby="amount-label"><g:fieldValue bean="${bankAccountInstance}" field="amount"/></span>
